      ...
      <div>
        <Link to="/home">
          <motion.img
            ...
            className="w-35 h-32 rounded-lg shadow-lg shadow-red-400"
            src={Logo}
            alt="Logo"
          />
        </Link>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-14">
        <div className="flex flex-wrap justify-center gap-4">
          ...
          >
            <FontAwesomeIcon
              icon={faGithub}
              className="text-[1.6rem] text-white rounded-lg shadow-xl shadow-red-600"
            />
          </motion.a>
          <motion.a
            transition={{
          ...
          >
            <FontAwesomeIcon
              icon={faInstagram}
              className="text-[1.6rem] text-white rounded-lg shadow-xl shadow-red-500"
            />
          </motion.a>
        </div>
        <Link to="/how-to-use">
