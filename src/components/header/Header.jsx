...
export default function Header() {
  ...
  return (
    <motion.header
      ...
      className={`padding flex justify-between items-center fixed rounded-lg ${
    ...
    >
      ...
      <Link to="/home">
        <motion.h1
          ...
          className="w-[4.5rem] p-2 font-extrabold text-primary text-xl"
      ...
      <nav className="flex">
        <ul
          className={`fixed z-50 inset-0  h-[100vh] w-[75%] flex flex-col ${
        ...
        <button
          ...
          className="flex items-center gap-10 cursor-pointer bg-transparent"
        >
          <motion.label
            whileHover={{
              scale: 1.15,
      ...
      <div
        onClick={handleNavStateChange}
        className={`overflow fixed z-[40] lg:hidden inset-0 h-[100vh] w-full  transition-all ${
          navState
